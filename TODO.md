# this TEST VERSION should only allow contributions using the test tokens from faucet
...
contributions on testnet are only made using the raiseboxtoken
raiseboxtokens can be obtained from the raiseboxfaucet ui or by calling the claimfaucetotken function from contract
